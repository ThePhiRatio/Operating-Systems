	  ...
	  {for (i = 0; i < 6 ; i++)
	    ...
	    /*Now execute instruction and increment PC (unless Branch) */
	     ...
	     {case 0:    OP0(IR) ; PC++; break ;
	      ...
	      case 99: printf("Process %d is ALL DONE\n",Current->PID) ; Done = 1 ; return(Done);
	      default: printf("Instruction %d not found!~\n", opcode) ;
	      exit(0) ;
	     }
	   }
	 printf("Process %d completed time slice. Placing at tail of the ready queue. ",Current->PID);
	 return(Done) ;
	 }
